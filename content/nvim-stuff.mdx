...
I code in Neovim with no AI autocomplete. No Copilot, no Codeium, no Supermaven whispering answers into my ear. Deliberate hard mode. The idea is that if I can't write it myself, I shouldn't be writing it yet.
